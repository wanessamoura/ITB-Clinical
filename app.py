...
APP_VERSION = "Versão 1.0 — 08/09/2026"
...
def pdf_report(d):
    ...
    sections = [
        ...
        (
            "Elegibilidade",
            [
                ["Sintomas de claudicação nos últimos 12 meses", display_value(d.get("claudicacao_12m"))],
...
def validate_form(
    ...
    if claudicacao_12m is None:
        pending.append("Sintomas de claudicação nos últimos 12 meses")
...
with tab1:
    ...
    claudicacao_12m = st.radio(
        "Sintomas de claudicação nos últimos 12 meses:",
        ["Sim", "Não"],
        index=None,
        horizontal=True,
    )
